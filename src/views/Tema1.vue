  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-lg-10
        .tarjeta.p-4(style="background-color: #a6eafe")
          .row.justify-content-center
            ...
            .col-lg-4.col-8: img(src='@/assets/curso/temas/tema1/2.svg', alt='' style="margin-bottom: -400px")
    ...
    .row.justify-content-center.mb-5
      .col-lg-6(data-aos="fade-right").mb-lg-0.mb-3
        ...
        .p-4(style="background-color: #1E5AF9; border-radius: 0px 0px 10px 10px ")
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-4(data-aos="fade-right").mb-lg-0.mb-3.h-100
        .h-100(style="background-color: #1E5AF9; border-radius: 0px 0px 10px 10px ")
          ...
          p.text-white.mb-0.p-4 #[b Práctica:] es la etapa en la que el equipo de seguridad realiza el análisis de riesgos, aprueba las solicitudes de cambio de seguridad, revisa las alertas de seguridad de los proveedores y la lista de correo CERT (Critical Emergency Response Team). También debe convertir los requisitos de la política de seguridad en implementaciones técnicas específicas con lenguaje sencillo.
      .col-lg-4(data-aos="fade-right").mb-lg-0.mb-3.h-100
        .h-100(style="background-color: #1E5AF9; border-radius: 0px 0px 10px 10px ")
      ...
      .col-lg-10
        .tarjeta.p-4(style="background-color: #CCBCFE")
          .row.justify-content-center.align-items-center
            .col-lg-4
              img(src='@/assets/curso/temas/tema1/20.svg', alt='' style="margin: -50px 0")
            .col-lg-8
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        .tarjeta.p-4(style="background-color: #CCBCFE")
          .row.justify-content-center.align-items-center
            .col-lg-4
              img(src='@/assets/curso/temas/tema1/28.svg', alt='' style="margin:  -50px 0")
            .col-lg-8
