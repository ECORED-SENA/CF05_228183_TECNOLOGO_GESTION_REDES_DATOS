  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Gestión y monitoreo
        p.mb-4 Reconozca los comandos y las claves que se utilizan para la resolución de problemas y la gestión de red simple a través de su aplicación.
